...
```{r, message= FALSE, warning=FALSE, error=FALSE, include = TRUE}
...
The packages includes function `check_harmonized_table()` to check whether a given data frame conforms in structure and content to what is later required for parameter table filling:
