...
```{r}
allom_path = "~/OneDrive/EMF_datasets/AllometryDatabases/"
```
...
### Querying allometry data for particular response
...
```{r}
SpParams<- traits4models::fill_medfate_allometries(SpParams, harmonized_allometry_path, 
