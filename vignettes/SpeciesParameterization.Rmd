---
title: "Building species parameter tables"
...
Once we have **medfate**, **medfatetraits** and  **medfuels**, we load them and other common packages that we will employ in this vignette:
```{r message=FALSE}
library(medfate)
