...
Package **traits4models** is developed and maintained by the [*Ecosystem Modelling Facility*](https://emf.creaf.cat) unit at [*CREAF*](https://www.creaf.cat/) with funding from [*CSIC*](https://www.csic.es/), in close collaboration with researchers from other institutions such as [*URFM-INRAE*](https://www6.paca.inrae.fr/ecologie_des_forets_mediterraneennes/) and [*CTFC*](https://www.ctfc.cat/).
