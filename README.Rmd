...
Package **traits4models** is designed to facilitate creating species parameter tables for package [medfate](https://github.com/emf-creaf/medfate). Specifically utility functions are provided to harmonize plant trait data bases and defining tables from them.
